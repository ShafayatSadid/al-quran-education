...
export default function AddCoursePage() {
  ...
  const [formData, setFormData] = useLocalStorage("courseFormData", {
    title: "",
    description: "",
    duration: "",
    students: "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.insertedId) {
        toast.success("কোর্স যোগ করা হয়েছে!");
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-end gap-3 pt-6 border-t border-border">
          ...
          >
            ...
            {loading ? "সংরক্ষণ হচ্ছে..." : "কোর্স যোগ করুন"}
          </Button>
        </div>
      </Form>
    </div>
